...
const StyledUserManagementEdit = styled(EditPopup)`
  ...
  .selector {
    ...
    min-width: 150px;
    cursor: pointer;
    border: 1px solid ${styles.linkSelector.border};
    background-color: ${styles.linkSelector.backround};
  }
  ...
  .dr-selecter li {
    ...
    &.selected,
    &:hover {
      color: ${styles.linkSelector.hoverColor};
      background-color: ${styles.linkSelector.hover};
    }
  }
`;
